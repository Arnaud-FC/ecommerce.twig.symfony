...
class CategoryController extends AbstractController
{
    ...
    {   
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $this->addFlash('success', 'votre categorie a ete créée');
    ...
    public function update(Category $category, EntityManagerInterface $em, Request $request): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $this->addFlash('success', 'votre categorie a ete modifiée');
    ...
    public function delete(Category $category, EntityManagerInterface $em): Response
    {
        ...
        $this->addFlash('danger', 'votre categorie a ete supprimé');
